...
<body data-spy="scroll" data-target="#main-navbar" class="body1">
    ...
    <div class="body">
        ...
        <form action="https://formspree.io/f/mdojevbl" method="post"> 
                        ...
                        <div class="page-header-wrapper">
                            <div class="container">
                                <div class="page-header text-center wow fadeInDown" data-wow-delay="0.1s">
                                    <h2 class="bl">Recuperar contraseña</h2>
                                    <div class="devider"></div>
                                    <p  class="bl">Ingresa tu correo electronico para actualizar tu contraseña</p>
                                </div>
                            </div>
                        </div>
                        <div class="centrado">
                                ...
                                <form role="form">
                                    <div class="form-group">
                                        <input type="email" name="email" class="form-control input-lg"
                                            placeholder="Igresa tu correo electronico" required>
                                    </div>
                                    
                                  
                                    <button type="submit" class="boton-env" data-wow-delay="0.8s">Enviar Correo</button>
                                    <br>
                                    <br><br>
